...
tspace4 ttoggle_panel::border_space() const
{
	...
	return tspace4{explicit_border_.left != twidget::npos? explicit_border_.left: conf->left_border, 
		explicit_border_.right != twidget::npos? explicit_border_.right: conf->right_border, 
		explicit_border_.top != twidget::npos? explicit_border_.top: conf->top_border, 
		explicit_border_.bottom != twidget::npos? explicit_border_.bottom: conf->bottom_border};
}
